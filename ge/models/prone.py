...
class ProNE:
    def __init__(self, graph, dimension, step=10, mu=0.5, theta=0.5):
        ...
        self.features_matrix = self.pre_factorization(self.matrix0, self.matrix0)
        self.embeddings_matrix = self.chebyshev_gaussian(self.matrix0, self.features_matrix, step, mu, theta)
        print(matrix0.shape)
    ...
    def get_embeddings(self):
        ...
        for i in range(self.node_number):
            self._embeddings[i] = self.embeddings_matrix[i, :]
