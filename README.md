...
|   ProNE   | [IJCAI 2019][ProNE: Fast and Scalable Network Representation Learning](https://www.ijcai.org/proceedings/2019/0594.pdf)     | [ProNE: 快速的图嵌入表示](https://zhuanlan.zhihu.com/p/77063856) |
...
model = ProNE(G, dimension = 16, step=10, mu=0.5, theta=0.5) #init model
embeddings = model.get_embeddings()# get embedding vectors
```
